    ...
    public function store(Request $request)
    {
        ...
        if (isset($request->validity)) {
            ...
            if ($userUpdate) {
                ...
                Mail::to($user->email)->queue(new CustomerPasswordResetSuccessMail(['name' => $user->name, 'email' => $user->email]));
            ...
            if ($customerUpdate) {
                ...
                // Send password reset success email
                Mail::to($customer->email)->queue(new CustomerPasswordResetSuccessMail(['name' => $customer->name, 'email' => $customer->email]));
