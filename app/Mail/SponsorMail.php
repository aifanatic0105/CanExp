...
class SponsorMail extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
        ...
        $rendered = $service->render('sponsor', ['data' => $this->data], $subject, null);
        ...
        return $this->markdown('mails/sponsor')
            ->subject($subject)
            ->with('data', $this->data);
    }
}
