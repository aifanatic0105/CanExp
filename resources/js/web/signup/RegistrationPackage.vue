    ...
    <div class="mb-4">
            ...
            >
              ...
              >
                ...
                <!-- <a
                  ...
                  class="mt-6 block rounded-md button-exp-fill"
                  @click.prevent="
                    updatePackageForm('package_type', freePackage)
                  "
                  >Select package</a
                > -->
                <ul
              ...
              >
                ...
                <a
                  href="#"
                  aria-describedby="tier-featured"
                  class="mt-6 block rounded-md button-exp-fill"
                  @click.prevent="
                    updatePackageForm('package_type', featuredPackage)
                  "
      ...
      <!-- <span
        v-html="
          ...
          regPageSetting.reg_page_setting_detail &&
          regPageSetting.reg_page_setting_detail[0]
            ? regPageSetting.reg_page_setting_detail[0].step_1_description
            : ''
        "
      ></span> -->
    </div>
