  ...
  <section class="mx-auto">
    ...
    <form class="bg-white">
      ...
      <div>
        ...
        <!-- <div
          class="mt-6 space-x-5 md:space-x-10 flex justify-center items-center"
        >
          <button
          ...
          >
            {{
              payment_setting &&
              JSON.parse(payment_setting) &&
              JSON.parse(payment_setting)["confirm_and_pay_btn_text"]
                ? JSON.parse(payment_setting)["confirm_and_pay_btn_text"]
                : ""
            }}
          </button>
...
export default {
  ...
  props: ["user", "url", "package_detail", "payment_setting"],
  data() {
    return {
      loading: false,
